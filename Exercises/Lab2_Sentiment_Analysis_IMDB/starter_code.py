...
def main():
    ...
    model = None  # [EXERCISE] Fill in: AutoModelForSequenceClassification.from_pretrained(model_name, local_files_only=True)
    device = "cuda" if torch.cuda.is_available() else "cpu"
    model.to(device)
    
    try:
        dataset = None  # [EXERCISE] Fill in: load_from_disk("local_datasets/imdb")
